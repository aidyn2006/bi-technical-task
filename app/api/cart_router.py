...
def get_session_id(x_session_id: str = Header(..., description="Session identifier for cart ownership")) -> str:
    return x_session_id
...
async def add_to_cart(
    ...
    return await service.add_item(session_id, payload)
...
async def update_cart_item(
    ...
    return await service.update_item(session_id, item_id, payload)
